...
myNewVal=$(echo $myString | sed -e 's/\ / /g')
}
...
myNewVal="SSTable count:"
pullStats "$myNewVal"

myNewVal="Space used (live), bytes"
pullStats "$myNewVal"

myNewVal="Space used (total), bytes:"
pullStats "$myNewVal"

myNewVal="SSTable Compression Ratio:"
pullStats "$myNewVal"

myNewVal="Number of keys (estimate):"
pullStats "$myNewVal"
 
myNewVal="Memtable cell count:"
pullStats "$myNewVal"

myNewVal="Memtable data size, bytes:"
pullStats "$myNewVal"

myNewVal="Memtable switch count:"
pullStats "$myNewVal"

myNewVal="Local read count:"
pullStats "$myNewVal"

myNewVal="Local read latency:"
pullStats "$myNewVal"

myNewVal="Local write count:"
pullStats "$myNewVal"

myNewVal="Local write latency:"
pullStats "$myNewVal"

myNewVal="Pending tasks:"
pullStats "$myNewVal"

myNewVal="Bloom filter false positives:"
pullStats "$myNewVal"

myNewVal="Bloom filter false ratio:"
pullStats "$myNewVal"

myNewVal="Bloom filter space used, bytes:"
pullStats "$myNewVal"

myNewVal="Compacted partition minimum bytes:"
pullStats "$myNewVal"

myNewVal="Compacted partition maximum bytes:"
pullStats "$myNewVal"

myNewVal="Compacted partition mean bytes:"
pullStats "$myNewVal"

myNewVal="Average live cells per slice (last five minutes):"
pullStats "$myNewVal"

myNewVal="Average tombstones per slice (last five minutes):"
pullStats "$myNewVal"
